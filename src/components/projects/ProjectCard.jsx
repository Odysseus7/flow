...
const ProjectCard = ({id, title, description, imgURL, URL, githubURL}) => {
    const linkIcon = <a href={URL} target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faExternalLinkAlt} className="projects__card__icon linkicon" /></a>;
    return (
        <article className="projects__card">
            <section className="projects__card__text">
                ...
                <article className="projects__card__iconContainer">
                    <a href={githubURL} target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faGithub} className="projects__card__icon" /></a>
                    {URL ? linkIcon : "" }
                </article>
            </section>
